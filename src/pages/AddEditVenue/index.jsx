    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          content={
            isEdit
              ? "Edit the details of the venue. Update the form with the necessary information and submit."
              : "Add a new venue by filling in the form with the required information and submit."
          }
        />
      </Helmet>
      <FormProvider {...methods}>
        ...
        >
          <div className="md:w-80 md:pb-8 md:pt-4">
            <h1 className="mb-2 pt-4 text-center text-2xl sm:text-3xl md:mb-4 md:ps-11 md:text-left">
